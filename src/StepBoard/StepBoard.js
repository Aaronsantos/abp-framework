    ...
    return (
        <main className="etapa">
            ...
            <div className="etapa-container">
                ...
                <section className="card atividades"> <h3 className="title">Como realizar? </h3>  <ul> {step.atividades.map(atvd => <li> {atvd} </li>)} </ul> </section>
                <section className="card lembrete"> <h3 className="title"> Atenção! </h3><hr /> <img src="lembrete.img" /> <p> {step.lembrete.texto} </p> </section>
            </div>
        </main>
    );
